    ...
    private function getModules(): array
    {
        return [
            ...
            [
                ...
                'color' => '#7A2E3D',
                'endpoints' => [
                    ['method' => 'GET', 'path' => 'kategori-berita', 'desc' => 'Menampilkan semua master kategori berita beserta terjemahannya'],
                    ['method' => 'POST', 'path' => 'kategori-berita', 'desc' => 'Membuat kategori berita baru'],
                    ['method' => 'GET', 'path' => 'kategori-berita/{id}', 'desc' => 'Detail kategori berita berdasarkan ID'],
                    ['method' => 'PUT', 'path' => 'kategori-berita/{id}', 'desc' => 'Memperbarui kategori berita'],
                    ['method' => 'DELETE', 'path' => 'kategori-berita/{id}', 'desc' => 'Menghapus kategori berita'],
                ],
            ],
            [
                'name' => 'Berita',
                ...
                'color' => '#A85C66',
                'endpoints' => [
                    ['method' => 'GET', 'path' => 'berita', 'desc' => 'Menampilkan semua data berita (termasuk relasi tags dan translations)'],
                    ['method' => 'POST', 'path' => 'berita', 'desc' => 'Membuat berita baru (upload gambar: gambar_utama, tag_ids)'],
                    ['method' => 'GET', 'path' => 'berita/active', 'desc' => 'Berita dengan status aktif (published)'],
                    ['method' => 'GET', 'path' => 'berita/slug/{slug}', 'desc' => 'Detail berita berdasarkan slug lengkap dengan galeri dan tags'],
                    ...
                    ['method' => 'DELETE', 'path' => 'berita/{id}', 'desc' => 'Menghapus berita beserta gambarnya'],
                ],
            ],
            [
                'name' => 'Tag Berita',
                ...
                'color' => '#9B4553',
                'endpoints' => [
                    ['method' => 'GET', 'path' => 'tag', 'desc' => 'Menampilkan semua master tag / topik berita'],
                    ['method' => 'POST', 'path' => 'tag', 'desc' => 'Membuat tag baru'],
                    ['method' => 'GET', 'path' => 'tag/{id}', 'desc' => 'Detail tag berdasarkan ID'],
                    ['method' => 'PUT', 'path' => 'tag/{id}', 'desc' => 'Memperbarui data tag'],
                    ['method' => 'PATCH', 'path' => 'tag/{id}/toggle-status', 'desc' => 'Aktif / nonaktifkan tag'],
                    ['method' => 'DELETE', 'path' => 'tag/{id}', 'desc' => 'Menghapus tag'],
                ],
            ],
            [
                'name' => 'Berita Galeri',
