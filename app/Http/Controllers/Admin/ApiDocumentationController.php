    ...
    private function getModules(): array
    {
        return [
            ...
            [
                ...
                'color' => '#A85C66',
                'endpoints' => [
                    ['method' => 'GET', 'path' => 'bahasa', 'desc' => 'Menampilkan semua bahasa terdaftar'],
                    ['method' => 'POST', 'path' => 'bahasa', 'desc' => 'Menambahkan bahasa baru (kode unik 2-5 karakter)'],
                    ['method' => 'GET', 'path' => 'bahasa/settings', 'desc' => 'Bahasa default dan daftar bahasa aktif saat ini'],
                    ['method' => 'GET', 'path' => 'bahasa/available', 'desc' => 'Daftar bahasa yang aktif'],
                    ['method' => 'POST', 'path' => 'bahasa/switch/{locale}', 'desc' => 'Ganti bahasa aktif sesi'],
                    ['method' => 'GET', 'path' => 'bahasa/{kode}', 'desc' => 'Detail bahasa berdasarkan kode'],
                    ['method' => 'PUT', 'path' => 'bahasa/{kode}', 'desc' => 'Memperbarui data bahasa'],
                    ['method' => 'PATCH', 'path' => 'bahasa/{kode}/set-default', 'desc' => 'Jadikan bahasa sebagai default'],
                    ['method' => 'PATCH', 'path' => 'bahasa/{kode}/toggle-status', 'desc' => 'Aktif / nonaktifkan bahasa'],
                    ['method' => 'DELETE', 'path' => 'bahasa/{kode}', 'desc' => 'Hapus bahasa beserta semua terjemahannya'],
                ],
            ],
        ];
    }
