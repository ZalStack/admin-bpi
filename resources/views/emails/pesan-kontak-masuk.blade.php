                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #650d1f 0%, #520A18 100%); padding: 28px 32px; text-align: left;">
                            ...
                            <p style="margin: 6px 0 0 0; font-size: 13px; color: #e2e8f0; opacity: 0.9;">
                                A new message has been received from the BPI website contact form.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 28px 32px;">
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 24px; background-color: #f8fafc; border-radius: 8px; border: 1px solid #edf2f7; padding: 16px;">
                                <tr>
                                    <td style="padding: 6px 12px; font-size: 12px; font-weight: 600; color: #64748b; width: 110px;">Name:</td>
                                ...
                                <tr>
                                    <td style="padding: 6px 12px; font-size: 12px; font-weight: 600; color: #64748b;">Received on:</td>
                                ...
                                <tr>
                                    <td style="padding: 6px 12px; font-size: 12px; font-weight: 600; color: #64748b;">Subject:</td>
                            ...
                            <!-- Reply Tip Callout -->
                            <div style="background-color: #eff6ff; border: 1px solid #bfdbfe; border-radius: 8px; padding: 14px 16px;">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td style="vertical-align: top; width: 24px; font-size: 16px;">💬</td>
                                        <td style="padding-left: 8px; font-size: 13px; color: #1e40af; line-height: 1.5;">
                                            <strong>How to Reply:</strong> You can directly click the <strong>Reply</strong> button in this email app. Your response will automatically be sent directly to <a href="mailto:{{ $kontakForm->email }}" style="color: #1d4ed8; text-decoration: underline; font-weight: 600;">{{ $kontakForm->email }}</a>.
                                        </td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <tr>
                        <td style="background-color: #f8fafc; padding: 20px 32px; text-align: center; border-top: 1px solid #edf2f7;">
                            <p style="margin: 0; font-size: 12px; color: #94a3b8; line-height: 1.5;">
                                This automated notification was sent by the BPI website system.
                            </p>
                        </td>
                    </tr>
