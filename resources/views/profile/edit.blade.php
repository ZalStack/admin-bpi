...
<div class="max-w-5xl mx-auto px-4 sm:px-6">
    ...
    <div class="mb-6 sm:mb-8">
        ...
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 font-poppins">Profile Saya</h1>
            ...
            <div x-data="{ editingProfile: false }">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-400">Perbarui nama dan email akun Anda</p>
                    </div>
                    <button @click="editingProfile = !editingProfile"
                        ...
                        <span x-text="editingProfile ? 'Tutup' : 'Edit Profil'"></span>
                    </button>
                </div>
            ...
            <div x-data="{
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
                    ...
                    <button @click="editingPassword = !editingPassword"
                        ...
                        <span x-text="editingPassword ? 'Tutup' : 'Ganti Password'"></span>
                    </button>
                </div>
                    ...
                    <form method="post" action="{{ route('profile.password.update') }}" class="space-y-4">
                        ...
                        <div class="mt-2">
                            <div class="flex items-center gap-2 text-xs text-gray-500">
                                ...
                                <span x-text="strength === 0 ? 'Kosong' : strength < 25 ? 'Lemah' : strength < 50 ? 'Sedang' : strength < 75 ? 'Kuat' : 'Sangat Kuat'"
                                      :class="{
                ...
                <div x-show="!editingPassword" x-transition.opacity.duration.200ms class="mt-4 flex items-start gap-3 rounded-xl bg-amber-50/80 border border-amber-200/60 px-4 py-3">
                    ...
                    <p class="text-sm text-amber-700 leading-relaxed">
                        Klik <strong>"Ganti Password"</strong> untuk memperbarui password akun Anda.
                        <span class="block mt-1 text-amber-600/80 text-xs">Pastikan password baru minimal 8 karakter dan mudah diingat.</span>
                    </p>
                </div>
            </div>
            ...
            <div class="bg-red-50/80 rounded-xl p-4 sm:p-5 border border-red-200/60">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="text-sm text-red-600/70 mt-0.5">Setelah akun dihapus, semua data akan hilang secara permanen</p>
                    </div>
