...
<div class="form-page">
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Tambahkan data mitra baru</p>
        </div>
        ...
        <form action="{{ route('admin.mitra.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group">
                <div>
                    ...
                    <input type="text" name="nama_id" id="nama_id" value="{{ old('nama_id') }}" class="form-input" required>
                    @error('nama_id')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <input type="text" name="nama_en" id="nama_en" value="{{ old('nama_en') }}" class="form-input" required>
                    @error('nama_en')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                ...
                <div>
                    ...
                    <textarea name="deskripsi_id" id="deskripsi_id" rows="4" class="form-textarea" required>{{ old('deskripsi_id') }}</textarea>
                    @error('deskripsi_id')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                ...
                <div>
                    ...
                    <textarea name="deskripsi_en" id="deskripsi_en" rows="4" class="form-textarea" required>{{ old('deskripsi_en') }}</textarea>
                    @error('deskripsi_en')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
            ...
            <div class="input-group">
                ...
                <div>
                    ...
                    <input type="url" name="website" id="website" value="{{ old('website') }}" class="form-input" placeholder="https://example.com">
                    @error('website')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                ...
                <div>
                    ...
                    <textarea name="alamat_id" id="alamat_id" rows="3" class="form-textarea">{{ old('alamat_id') }}</textarea>
                    @error('alamat_id')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                ...
                <div>
                    ...
                    <textarea name="alamat_en" id="alamat_en" rows="3" class="form-textarea">{{ old('alamat_en') }}</textarea>
                    @error('alamat_en')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
