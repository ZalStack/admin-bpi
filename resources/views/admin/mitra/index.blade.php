                    ...
                    <tbody class="tbody">
                        @foreach($items as $item)
                            <tr class="tr-hover">
                                <td class="td">
                                    @if($item->logo)
                                        <img src="{{ asset('storage/mitra/'.$item->logo) }}" alt="logo" class="thumb" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
                                ...
                                <td class="td font-medium text-gray-800">{{ Str::limit($item->translateField('nama'), 30) }}</td>
                                ...
                                <td class="td hidden lg:table-cell text-sm text-gray-600">{{ $item->website ?: '-' }}</td>
                                <td class="td hidden md:table-cell">
