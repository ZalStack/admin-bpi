...
<div>
    <div class="page-header">
        <div>
            ...
            <h1 class="page-title">Kategori Mitra</h1>
            <p class="page-subtitle">Kelola kategori pengelompokan mitra (Strategis, Internasional, Industri, Komunitas, dll)</p>
    ...
    @if($items->isEmpty())
        <div class="empty-state">
            ...
            <h3 class="empty-title">Belum ada kategori mitra</h3>
            <p class="empty-desc">Tambahkan kategori untuk mengelompokkan mitra di landing page.</p>
        </div>
    @else
                ...
                <table class="table">
                    <thead class="thead">
                        <tr>
                            ...
                            <th class="th">Slug Kategori</th>
                            <th class="th text-center">Urutan</th>
                            ...
                            <tr class="tr-hover">
                                ...
                                <td class="td text-right">
                                    <div class="flex items-center justify-end gap-1.5">
                                        ...
                                        <form action="{{ route('admin.kategori-mitra.destroy', $item->id) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus kategori ini? Mitra dengan kategori ini mungkin perlu disesuaikan.')">
                                            @csrf
                                            @method('DELETE')
