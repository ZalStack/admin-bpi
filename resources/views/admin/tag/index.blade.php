                ...
                <table class="table">
                    ...
                    <tbody class="tbody">
                        @foreach($items as $item)
                            <tr class="tr-hover">
                                <td class="td font-medium text-gray-800">{{ Str::limit($item->translateField('tag'), 30) }}</td>
                                <td class="td hidden md:table-cell text-sm text-gray-500">{{ $item->slug }}</td>
                                <td class="td hidden md:table-cell">
                                    <button onclick="toggleStatus('tag', {{ $item->id }})" class="{{ $item->status ? 'badge-active' : 'badge-inactive' }} transition-transform hover:scale-105 cursor-pointer">
                                ...
                                <td class="td text-right">
                                    <div class="flex items-center justify-end gap-1.5">
                                        <a href="{{ route('admin.tag.edit', $item->id) }}" class="icon-btn-edit" title="Edit">
