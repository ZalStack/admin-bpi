        ...
        <form action="{{ route('admin.program-roadmap.update', $item->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="input-group">
                ...
                <div>
                    ...
                    <input type="text" name="icon" id="icon" value="{{ old('icon', $item->icon) }}" class="form-input" placeholder="fa-solid fa-puzzle-piece">
            ...
            <div>
                ...
                @if($item->gambar)
                    <div class="mb-3">
                        ...
                        <img src="{{ asset('storage/program/'.$item->gambar) }}" alt="peta jalan" class="h-28 w-auto max-w-xs rounded-xl object-contain bg-white p-2 border border-gray-200 ring-1 ring-gray-100">
                    </div>
                @endif
