...
<div class="form-page">
    <div class="page-header">
        <div>
            ...
            <h1 class="page-title">Add Program Pillar</h1>
            <p class="page-subtitle">Add a new strategic program pillar with its sub-program points</p>
        </div>
    ...
    <div class="form-card">
        <form action="{{ route('admin.program.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="input-group">
                <div>
                    <x-icon-picker name="icon" :value="old('icon', 'fa-solid fa-coins')" label="Program Pillar Icon" />
                </div>
            ...
            @foreach ($bahasas as $bahasa)
                <x-lang-panel :kode="$bahasa->kode" class="grid grid-cols-1 gap-4">
                    <x-trans-input field="judul" label="Program Pillar Title" :kode="$bahasa->kode" :required="$bahasa->is_default" placeholder="e.g.: Financing and Investment"/>
                    <x-trans-textarea field="deskripsi" label="Introduction Description" :kode="$bahasa->kode" :required="$bahasa->is_default" rows="3" placeholder="Brief description of this program pillar..."/>
                </x-lang-panel>
            @endforeach
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Add sub-point cards within this program pillar.</p>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div x-show="poinList.length === 0" class="text-center py-6 border-2 border-dashed border-gray-200 rounded-2xl bg-white">
                        <p class="text-xs text-gray-400">No sub-points added yet. Click "Add Sub-Point" above.</p>
                    </div>
                </div>
            </div>
