            ...
            @foreach ($bahasas as $bahasa)
                ...
                <x-lang-panel :kode="$bahasa->kode" class="grid grid-cols-1 gap-4">
                    ...
                    <div class="input-group">
                        ...
                        <x-trans-input field="kategori" label="Kategori" :kode="$bahasa->kode" :required="$req" placeholder="{{ $req ? 'cth: Infrastruktur' : 'Category' }}"/>
                    </div>

                    <x-trans-textarea field="deskripsi_singkat" label="Deskripsi Singkat" :kode="$bahasa->kode" :required="$req" rows="3" placeholder="Deskripsi singkat dalam bahasa {{ $bahasa->nama }}"/>

                    <div class="mt-4">
                        <x-trans-textarea field="deskripsi" label="Deskripsi Lengkap" :kode="$bahasa->kode" :required="$req" rows="5" placeholder="Deskripsi lengkap dalam bahasa {{ $bahasa->nama }}"/>
                    </div>

                    <div class="mt-4">
                        <x-trans-input field="lokasi" label="Lokasi" :kode="$bahasa->kode" :required="$req" placeholder="{{ $req ? 'cth: Jakarta' : 'e.g: Jakarta' }}"/>
                    </div>
