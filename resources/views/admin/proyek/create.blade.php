...
<div class="form-page">
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Add a new project complete with objectives, achievements, activities, timeline, and related partners</p>
        </div>
        ...
        <form action="{{ route('admin.proyek.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="input-group">
                <div>
                    ...
                    <input type="text" name="tahun" id="tahun" value="{{ old('tahun', date('Y').' - Sekarang') }}" class="form-input" placeholder="e.g.: 2024 - Present" required>
                    @error('tahun')
            ...
            <div class="mt-4">
                ...
                <p class="mt-1.5 text-xs text-gray-400">Format: JPG, PNG, WEBP. Maximum 2MB.</p>
                @error('gambar_utama')
                    <p class="form-error">{{ $message }}</p>
                @enderror
            </div>
            ...
            @foreach ($bahasas as $bahasa)
                ...
                <x-lang-panel :kode="$bahasa->kode" class="space-y-6">
                    ...
                    <div>
                        <x-trans-textarea field="deskripsi_singkat" label="Short Description" :kode="$bahasa->kode" :required="$req" rows="2" placeholder="1-2 sentence summary for project card"/>
                    </div>
                    ...
                    <div>
                        <x-trans-input field="timeline" label="Brief Timeline" :kode="$bahasa->kode" :required="$req" placeholder="e.g.: 2022 - Present"/>
                    </div>
