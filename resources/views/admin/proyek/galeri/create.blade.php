...
<div class="form-page">
    ...
    <div class="form-card">
        <form action="{{ route('admin.proyek.galeri.store', $proyek->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="input-group">
                <div>
                    ...
                    <input type="text" name="judul_id" id="judul_id" value="{{ old('judul_id') }}" class="form-input">
                    @error('judul_id')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                ...
                <div>
                    ...
                    <input type="text" name="judul_en" id="judul_en" value="{{ old('judul_en') }}" class="form-input">
                    @error('judul_en')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                ...
                <div>
                    ...
                    <textarea name="deskripsi_id" id="deskripsi_id" rows="3" class="form-textarea">{{ old('deskripsi_id') }}</textarea>
                    @error('deskripsi_id')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                ...
                <div>
                    ...
                    <textarea name="deskripsi_en" id="deskripsi_en" rows="3" class="form-textarea">{{ old('deskripsi_en') }}</textarea>
                    @error('deskripsi_en')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
