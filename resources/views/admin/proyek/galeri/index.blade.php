...
<div>
    ...
    @if($items->isEmpty())
        <div class="empty-state">
            ...
            <h3 class="empty-title">Belum ada galeri untuk proyek ini</h3>
            <p class="empty-desc">Tambahkan gambar galeri untuk proyek ini.</p>
        </div>
    @else
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between mt-3 pt-3 border-t border-gray-100">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <form action="{{ route('admin.proyek.galeri.destroy', [$proyek->id, $galeri->id]) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus galeri ini?')">
                                    @csrf
                                    @method('DELETE')
