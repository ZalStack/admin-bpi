...
<div class="form-page">
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Proyek: {{ $proyek->translateField('judul') }}</p>
        </div>
        <a href="{{ route('admin.proyek.galeri.index', $proyek->id) }}" class="btn-outline">Kembali</a>
    </div>
