        ...
        <form action="{{ route('admin.struktur.update', $item->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="telepon" id="telepon" value="{{ old('telepon', $item->telepon) }}" class="form-input" placeholder="0812-3456-7890">
                    @error('telepon')
                        <p class="form-error">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div>
                ...
                @if($item->foto)
                    <div class="mb-3">
                        ...
                        <img src="{{ asset('storage/struktur/'.$item->foto) }}" alt="foto" class="h-44 w-full max-w-md rounded-xl object-cover ring-1 ring-gray-200">
                    </div>
                @endif
