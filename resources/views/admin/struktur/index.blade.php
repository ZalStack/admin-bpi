...
<div>
    <div class="page-header">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.struktur.layout') }}" class="btn-outline flex items-center gap-2 border-[#520A18]/30 text-[#520A18] hover:bg-[#520A18] hover:text-white transition-all shadow-sm">
