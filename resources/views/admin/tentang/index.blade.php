...
<div>
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Manage content, titles, vision/mission pillars, and display status on the About page</p>
    ...
    @if($items->isEmpty())
        <div class="empty-state">
            ...
            <h3 class="empty-title">No about section data yet</h3>
            <p class="empty-desc">About section data has not been initialized yet.</p>
        </div>
    @else
                            ...
                            <tr class="tr-hover">
                                ...
                                <td class="td text-right">
                                    <div class="flex items-center justify-end gap-1.5">
                                        <a href="{{ route('admin.tentang.edit', $item->id) }}" class="icon-btn-edit" title="Edit Content & Points">
                                            <svg class="w-4.5 h-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                        </a>
                                        <form action="{{ route('admin.tentang.destroy', $item->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this data?')">
                                            @csrf
                                            @method('DELETE')
