        ...
        <form action="{{ route('admin.kontak.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <textarea name="deskripsi_id" id="deskripsi_id" rows="3" class="form-textarea" placeholder="Deskripsi dalam Bahasa Indonesia" required>{{ old('deskripsi_id') }}</textarea>
                    @error('deskripsi_id')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                ...
                <div>
                    ...
                    <textarea name="deskripsi_en" id="deskripsi_en" rows="3" class="form-textarea" placeholder="Description in English" required>{{ old('deskripsi_en') }}</textarea>
                    @error('deskripsi_en')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <textarea name="alamat_id" id="alamat_id" rows="2" class="form-textarea" placeholder="Alamat dalam Bahasa Indonesia">{{ old('alamat_id') }}</textarea>
                    @error('alamat_id')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                ...
                <div>
                    ...
                    <textarea name="alamat_en" id="alamat_en" rows="2" class="form-textarea" placeholder="Address in English">{{ old('alamat_en') }}</textarea>
                    @error('alamat_en')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" step="0.0000001" name="latitude" id="latitude" value="{{ old('latitude') }}" class="form-input" placeholder="-6.2000000">
                    @error('latitude')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                ...
                <div>
                    ...
                    <input type="number" step="0.0000001" name="longitude" id="longitude" value="{{ old('longitude') }}" class="form-input" placeholder="106.8000000">
                    @error('longitude')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
