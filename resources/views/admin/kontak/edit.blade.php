        ...
        <form action="{{ route('admin.kontak.update', $item->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="latitude" id="latitude" value="{{ old('latitude', $item->latitude) }}" class="form-input" placeholder="-6.2500000">
                    @error('latitude')
                ...
                <div>
                    ...
                    <input type="text" name="longitude" id="longitude" value="{{ old('longitude', $item->longitude) }}" class="form-input" placeholder="106.8500000">
                    @error('longitude')
                        <p class="form-error">{{ $message }}</p>
                    @enderror
                </div>
