...
<div>
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Manage contact information, social media, email, phone, and location map</p>
    ...
    @if($items->isEmpty())
        <div class="empty-state">
            ...
            <h3 class="empty-title">No contact data yet</h3>
            <p class="empty-desc">Add company contact information.</p>
        </div>
    @else
        <div class="table-container">
            <div class="table-scroll">
                <table class="table">
                    <thead class="thead">
                        <tr>
                            <th class="th">Title / Address</th>
                            <th class="th hidden md:table-cell">Social Media</th>
                            <th class="th hidden lg:table-cell">Email</th>
                            <th class="th hidden sm:table-cell">Phone / WA</th>
                        ...
                        @foreach($items as $item)
                            <tr class="tr-hover">
                                <td class="td font-medium text-gray-800">
                                    ...
                                    <div class="text-xs text-gray-500 line-clamp-1 mt-0.5">{{ $item->translateField('alamat') ?? 'Coordinates: '.$item->latitude.', '.$item->longitude }}</div>
                                </td>
                                ...
                                <td class="td text-right">
                                    <div class="flex items-center justify-end gap-1.5">
                                        ...
                                        <form action="{{ route('admin.kontak.destroy', $item->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this data?')">
                                            @csrf
                                            @method('DELETE')
