...
<div>
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Manage news and their galleries ({{ strtoupper(\App\Models\Bahasa::defaultKode()) }} displayed)</p>
    ...
    @if($items->isEmpty())
        <div class="empty-state">
            ...
            <h3 class="empty-title">No news data yet</h3>
            <p class="empty-desc">Start by adding a new article.</p>
        </div>
    @else
                            ...
                            <tr class="tr-hover">
                                ...
                                <td class="td text-right">
                                    <div class="flex items-center justify-end gap-1.5">
                                        <a href="{{ route('admin.berita.galeri.index', $item->id) }}" class="icon-btn-gold" title="Gallery">
                                        ...
                                        <form action="{{ route('admin.berita.destroy', $item->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this data?')">
                                            @csrf
                                            @method('DELETE')
