...
<div>
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Manage organization stakeholder list ({{ strtoupper(\App\Models\Bahasa::defaultKode()) }} displayed)</p>
    ...
    @if($items->isEmpty())
        <div class="empty-state">
            ...
            <h3 class="empty-title">No stakeholder data yet</h3>
            <p class="empty-desc">Start by adding a new stakeholder.</p>
        </div>
    @else
            ...
            <div class="table-scroll">
                <table class="table">
                    <thead class="thead">
                        <tr>
                            <th class="th">Name</th>
                            <th class="th hidden md:table-cell">Image</th>
                            ...
                            <tr class="tr-hover">
                                ...
                                <td class="td text-right">
                                    <div class="flex items-center justify-end gap-1.5">
                                        ...
                                        <form action="{{ route('admin.stakeholder.destroy', $item->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this data?')">
                                            @csrf
                                            @method('DELETE')
