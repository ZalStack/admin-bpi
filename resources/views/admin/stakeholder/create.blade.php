...
<div class="form-page">
    <div class="page-header">
        <div>
            ...
            <h1 class="page-title">Tambah Stakeholder</h1>
            <p class="page-subtitle">Tambahkan stakeholder organisasi baru</p>
        </div>
        ...
        <form action="{{ route('admin.stakeholder.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group">
                <div>
                    ...
                    <input type="text" name="nama_id" id="nama_id" value="{{ old('nama_id') }}" class="form-input" placeholder="Nama dalam Bahasa Indonesia" required>
                    @error('nama_id')
                        <p class="form-error">
                ...
                <div>
                    ...
                    <input type="text" name="nama_en" id="nama_en" value="{{ old('nama_en') }}" class="form-input" placeholder="Name in English" required>
                    @error('nama_en')
                        <p class="form-error">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
