...
<div class="form-page">
    ...
    <div class="form-card">
        <form action="{{ route('admin.beranda.update', $item->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="input-group">
                <div>
                    ...
                    <input type="text" name="section" id="section" value="{{ old('section', $item->section) }}" class="form-input" placeholder="cth: hero, tentang, visi" required>
                    @error('section')
            ...
            <div>
                ...
                @if($item->gambar)
                    <div class="mb-3">
                        ...
                        <img src="{{ asset('storage/beranda/'.$item->gambar) }}" alt="beranda" class="h-44 w-full max-w-md rounded-xl object-cover ring-1 ring-gray-200">
                    </div>
                @endif
