...
<div>
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Kelola konten section halaman beranda ({{ strtoupper(\App\Models\Bahasa::defaultKode()) }} ditampilkan)</p>
                        ...
                        @foreach($items as $item)
                            <tr class="tr-hover">
                                ...
                                <td class="td hidden lg:table-cell">
                                    @if($item->gambar)
                                        <img src="{{ asset('storage/beranda/'.$item->gambar) }}" alt="beranda" class="thumb" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
                                ...
                                <td class="td hidden md:table-cell">
                                    <button onclick="toggleStatus('beranda', {{ $item->id }})" class="{{ $item->status ? 'badge-active' : 'badge-inactive' }} transition-transform hover:scale-105 cursor-pointer">
                                ...
                                <td class="td text-right">
                                    <div class="flex items-center justify-end gap-1.5">
                                        <a href="{{ route('admin.beranda.edit', $item->id) }}" class="icon-btn-edit" title="Edit">
