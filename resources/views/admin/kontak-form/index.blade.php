...
<div>
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Kelola pesan yang masuk dari form kontak</p>
    ...
    @if($forms->isEmpty())
        <div class="empty-state">
            ...
            <p class="empty-desc">Belum ada pesan yang masuk dari form kontak.</p>
        </div>
    @else
                ...
                <table class="table">
                    <thead class="thead">
                        <tr>
                            ...
                            <th class="th hidden sm:table-cell">Subjek</th>
                            <th class="th hidden md:table-cell">Status</th>
                            <th class="th hidden lg:table-cell">Tanggal</th>
                            ...
                            <tr class="tr-hover">
                                ...
                                <td class="td text-right">
                                    <div class="flex items-center justify-end gap-1.5">
                                        ...
                                        <form action="{{ route('admin.kontak-form.destroy', $form->id) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus pesan ini?')">
                                            @csrf
                                            @method('DELETE')
