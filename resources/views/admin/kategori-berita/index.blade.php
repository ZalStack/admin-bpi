...
<div>
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Kelola master kategori untuk pengelompokan artikel berita</p>
    ...
    @if($items->isEmpty())
        <div class="empty-state">
            ...
            <h3 class="empty-title">Belum ada data kategori berita</h3>
            <p class="empty-desc">Mulai dengan menambahkan kategori berita baru.</p>
        </div>
    @else
            ...
            <div class="table-scroll">
                <table class="table">
                    <thead class="thead">
                        <tr>
                            <th class="th">#</th>
                            <th class="th">Judul (Bahasa Default)</th>
                            <th class="th hidden md:table-cell">Terjemahan Lain</th>
                            ...
                            <tr class="tr-hover">
                                ...
                                <td class="td text-right">
                                    <div class="flex items-center justify-end gap-1.5">
                                        ...
                                        <form action="{{ route('admin.kategori-berita.destroy', $item->id) }}" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus kategori ini?')">
                                            @csrf
                                            @method('DELETE')
