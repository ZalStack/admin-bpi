...
<div class="form-page">
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Add a new news category with multilingual titles and customizable badge color</p>
        </div>
        ...
        <form action="{{ route('admin.kategori-berita.store') }}" method="POST"
            x-data="{
                ...
                getLiveTitle() {
                    ...
                    return (activeInput && activeInput.value.trim()) ? activeInput.value.trim() : 'Category Name';
                },
                hexToRgba(hex, alpha) {
